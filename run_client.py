...
def main():
    ...
    parser.add_argument('--translate', action='store_true', help="If set, the task will be translation instead of transcription.")
    ...
    parser.add_argument('--save_output_recording', action='store_true', help="Whether to save the microphone recording.")
    parser.add_argument('--output_recording_filename', type=str, default="./output_recording.wav", help="Path to save the output recording WAV file.")
    parser.add_argument('--output_transcription_path', type=str, default="./output.srt", help="File path to save the output transcription (SRT file).")
    parser.add_argument('--log_transcription', action='store_true', help="Whether to log transcription output to the console.")
    parser.add_argument('--max_clients', type=int, default=4, help="Maximum number of client connections allowed.")
    parser.add_argument('--max_connection_time', type=int, default=600, help="Maximum allowed connection time in seconds.")
    parser.add_argument('--mute_audio_playback', action='store_true', help="If set, mutes audio playback during file playback.")
